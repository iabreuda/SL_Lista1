...
\begin{document}
    ...
    \section{Quest\~{a}o 7 - Classificação de Sistemas}
        \subsection{Item a}
		$y_{1}(t) = \int_{-5}^{5}f_{1}(\tau)d\tau$, considerando $f_{2}(t) = f_{1}(t-t_{0})$, temos $y_{2}(t) = \int_{-5}^{5}f_{2}(\tau)d\tau = \int_{-5}^{5}f_{1}(\tau - t_{0})d\tau = y_{1}(t-t_{0})$, logo é invariante no tempo.
        \subsection{Item b}
        $y_{1}(t) = f_{1}^{'2}(t)$, considerando $f_{2}^{'2}(t) = f_{1}^{'2}(t-t_{0})$, temos $y_{2}(t) = f_{2}^{'2}(t) =f_{1}^{'2}(t-t_{0}) =  y_{1}(t)$, logo é invariante no tempo.
...
%        Logo a energia é: $\frac{41}{6}$        
    \section{Quest\~{a}o 9 - Operação com Sinais}
                ...
                \addplot+[const plot, no marks, thick] coordinates {(-4,0) (-3,0) (-3,1) (-2,1) (-1,1) (0,1)} {};
                \addplot[domain=0:2,blue]{-x/2 +1};
                \addplot+[const plot, no marks, thick] coordinates {(3,0) (4,0)} {};
                \end{axis}
                \end{tikzpicture}    
        \subsection{Item a}
                \begin{tikzpicture}
                ...
                \addplot+[const plot, no marks, thick] coordinates {(-3,0) (-2,0) (-2,1) (-1,1) (0,1) (1,1)} {};
                \addplot[domain=1:3,blue]{-x/2 +1.5};
                \addplot+[const plot, no marks, thick] coordinates {(4,0) (5,0)} {};
                \end{axis}
                \end{tikzpicture}         
        \subsection{Item b}
                \begin{tikzpicture}
                ...
                \addplot[domain=-4:-2,blue]{x/2+2};
                \addplot+[const plot, no marks, thick, blue] coordinates {(-2,1)(-1,1) (0,1) (1,1) (-1,1) (0,1) (1,1) (1,0)} {};	
                \end{axis}
                \end{tikzpicture}         
        \subsection{Item c}
                \begin{tikzpicture}
                ...
                \addplot+[const plot, no marks, thick] coordinates {(-2,0) (-1.5,0) (-1.5,1) (-1,1) (-0.5,1) (0,1)} {};
                \addplot[domain=0:1,blue]{-x+1};
                \addplot+[const plot, no marks, thick] coordinates {(3,0) (4,0)} {};
                \end{axis}
                \end{tikzpicture}        
        \subsection{Item d}
                ...
                \addplot+[const plot, no marks, thick] coordinates {(-4,0) (-3,0) (-3,1) (-2,1) (-1,1) (0,1)} {};
                \addplot[domain=0:2,blue]{-x^2/2 +1};
                \end{axis}
                \end{tikzpicture}        
    \section{Quest\~{a}o 10 - Operação com Sinais}
        \subsection{Item a}
            \begin{figure}[!ht]
            	\centering
            	\includegraphics{img/Figura9.PNG}
            	\caption{Questao 10 - Plot item a}
            \end{figure}          
        ...
        \subsection{Item b}
            \begin{figure}[!ht]
            	\centering
            	\includegraphics{img/Figura10.PNG}
            	\caption{Questao 10 - Plot item b}
            \end{figure}             
